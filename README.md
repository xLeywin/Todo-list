...
# Sobre o projeto
Este é um projeto de lista de tarefas (To-Do List) desenvolvido com HTML, CSS e JavaScript como forma de praticar e consolidar alguns conceitos de front-end. A aplicação permite que o usuário:
- Adicione novas tarefas através de um input.
